...
===============Surge=================
京东金融养猪猪 = type=cron,cronexp="12 * * * *",wake-system=1,timeout=3600,script-path=https://jdsharedresourcescdn.azureedge.net/jdresource/jd_pigPet.js

============小火箭=========
京东金融养猪猪 = type=cron,script-path=https://jdsharedresourcescdn.azureedge.net/jdresource/jd_pigPet.js, cronexpr="12 * * * *", timeout=3600, enable=true
 */
